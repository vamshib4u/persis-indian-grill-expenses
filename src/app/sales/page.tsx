...
export default function SalesPage() {
  ...
  const { sales, transactions, allSales, allTransactions, allCateringOrders, cashHolders, activeRestaurantId } = useMemo(() => {
    void storageVersion;
    ...
    return {
      sales: monthlySales.sort((a, b) => parseDateOnly(a.date).getTime() - parseDateOnly(b.date).getTime()),
